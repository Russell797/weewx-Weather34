...
if ($weather["wind_speed"]<10){echo "&nbsp;&nbsp;&#8239;" .number_format(round($weather["wind_speed"],0));}else echo "&nbsp;&#8239;" .number_format(round($weather["wind_speed"],0));?>
...
<?php  
if ($weather["wind_gust_speed"]*$toKnots>=26.9978){echo "&nbsp;&#8239;","<windred>",number_format(round($weather["wind_gust_speed"],0)),"</span>";}else if ($weather["wind_gust_speed"]*$toKnots>=21.5983){echo "&nbsp;&#8239;","<windorange>",number_format(round($weather["wind_gust_speed"],0)),"</span>";}else if ($weather["wind_gust_speed"]*$toKnots>=16.1987){echo "&nbsp;&#8239;","<windgreen>",number_format(round($weather["wind_gust_speed"],0)),"</span>";}else if ($weather["wind_gust_speed"]<10){echo "&nbsp;&nbsp;&#8239;",number_format(round($weather["wind_gust_speed"],0));}else echo "&nbsp;&#8239;",number_format(round($weather["wind_gust_speed"],0));?>
...
<?php echo "<valuetext>Max "."<max><value><maxred>".number_format(round($weather["wind_gust_speed_max"],1))."</maxred></max></span>"."<supmb> ".$weather["wind_units"]."</supmb><br> ".$lang['Gust']." (".$weather["winddmaxtime"].")</valuetext>";?></div>
...
<?php if ($weather["wind_units"] == 'mph') echo 'mi'; else if ($weather["wind_units"] == 'm/s') echo ''; else if ($weather["wind_units"] == 'kn') echo 'NM';else echo 'km';?></weather34windrunspan>
